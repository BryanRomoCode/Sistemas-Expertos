...
def dijkstra(grafo, fuente, destino):
    ...
    # Inicializar el grafo de NetworkX
    G = nx.Graph(grafo)
    pos = nx.spring_layout(G)
    
    # Inicializar las distancias de la fuente a todos los nodos como infinito
    distancias = {nodo: math.inf for nodo in grafo}
    # La distancia de la fuente a sí misma es cero
    distancias[fuente] = 0
    # Lista de nodos sin visitar
    ...
    while nodos_sin_visitar:
        ...
        # Si se llegó al nodo de destino, se puede salir del bucle
...
# Definir el grafo fuera de la función
grafo = {
    'A': {'B':2, 'C': 3},
    'B': {'A':2, 'D':1},
    'C': {'A':3, 'D':4, 'E': 5},
